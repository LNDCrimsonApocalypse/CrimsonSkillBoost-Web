...
<div class="navbar">
  ...
  <div class="modal-overlay">
    <form class="modal" action="/task/duedate/<?= esc($task['id']) ?>" method="post">
      <button class="modal-close" title="Close" type="button">&times;</button>
      ...
      <div class="modal-checkbox-row">
        <input type="checkbox" id="late-submission" name="allow_late" value="1" />
      ...
      <div class="modal-options-row">
        ...
        <input type="number" id="attempts" name="attempts" min="0" value="0" required />
        <div class="modal-options-note">Based on best attempt</div>
      </div>
      <div class="modal-footer">
        <button class="modal-done-btn" type="submit">Done</button>
      </div>
    </form>
  </div>
