...
<body>
  ...
  <div class="main-container">
    <form action="/quiz/options/<?= esc($quiz_id) ?>" method="post">
      <div class="question-box">
        <input type="text" name="question_text" placeholder="Type question here" style="width:90%;font-size:24px;border:none;background:transparent;text-align:center;" required>
      </div>
      <div class="options-container">
        ...
        <div class="option <?= $colors[$i] ?>">
          ...
          <input type="text" name="options[]" placeholder="Type answer option here" style="width:80%;border:none;background:transparent;text-align:center;" required>
          <input type="radio" name="correct_option" value="<?= $i ?>" required title="Mark as correct answer" style="position:absolute;bottom:10px;right:10px;">
        </div>
        <?php endfor; ?>
      </div>
      <div class="save-btn">
