...
<body>
  ...
  <div class="modal">
    ...
    <h2>Add Content</h2>
    <form action="<?= base_url('quiz/upload') ?>" method="post" enctype="multipart/form-data">
      <label>Quiz Name:</label>
      <input type="text" name="quiz_name" placeholder="Enter file name" required>
      ...
      <button type="submit" class="create-btn" name="create_own" value="1">CREATE OWN QUIZ</button>
    </form>
  </div> 

  <script>
    // Prevent form submission when clicking Import Content
